...
# -------------------------------------------------------------------------
# 1. FFmpeg 실행 파일 경로 자동 탐색 (환경 의존성 제거)
# -------------------------------------------------------------------------
try:
...
# -------------------------------------------------------------------------
# 3. Rate Limit 및 동시성 제어 (Render 무료 티어 OOM 방어)
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# 6. 메인 렌더링 엔드포인트 (404 방지를 위한 다중 라우트 매핑)
# -------------------------------------------------------------------------
...
""")
                ...
                # 원본 볼륨 0.2로 감쇠(Ducking) + 새 TTS 볼륨 1.2로 믹싱
